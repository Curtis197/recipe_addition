...
class CreateRecipeModel extends FlutterFlowModel<CreateRecipeWidget> {
  ...
  bool isDataUploading_uploadLocalMainImage = false;
  FFUploadedFile uploadedLocalFile_uploadLocalMainImage =
      FFUploadedFile(bytes: Uint8List.fromList([]), originalFilename: '');
  String uploadedFileUrl_uploadLocalMainImage = '';
  ...
  bool isDataUploading_uploadLocalImages = false;
  FFUploadedFile uploadedLocalFile_uploadLocalImages =
      FFUploadedFile(bytes: Uint8List.fromList([]), originalFilename: '');
  String uploadedFileUrl_uploadLocalImages = '';

  // Stores action output result for [Backend Call - Insert Row] action in Container widget.
  ReceipeImageRow? insertImage;
  bool isDataUploading_uploadRecipeImage = false;
  FFUploadedFile uploadedLocalFile_uploadRecipeImage =
      FFUploadedFile(bytes: Uint8List.fromList([]), originalFilename: '');
