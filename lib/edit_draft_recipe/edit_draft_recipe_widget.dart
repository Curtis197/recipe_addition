...
import 'edit_draft_recipe_model.dart';
export 'edit_draft_recipe_model.dart';

class EditDraftRecipeWidget extends StatefulWidget {
  const EditDraftRecipeWidget({
    super.key,
  ...
  static String routeName = 'edit-draft-recipe';
  static String routePath = '/editDraftRecipe';

  @override
  State<EditDraftRecipeWidget> createState() => _EditDraftRecipeWidgetState();
}

class _EditDraftRecipeWidgetState extends State<EditDraftRecipeWidget> {
  late EditDraftRecipeModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => EditDraftRecipeModel());
    ...
    SchedulerBinding.instance.addPostFrameCallback((_) async {
      await Future.wait([
        Future(() async {
          ...
          _model.title = widget.recipeID?.name;
          _model.description = widget.recipeID?.description;
          _model.type = widget.recipeID!.type.toList().cast<String>();
          _model.region = widget.recipeID?.foodRegion;
          _model.hPrep = widget.recipeID?.timeOfCookingHour;
          _model.minPrep = widget.recipeID?.timeOfCookingMin;
          _model.difficulty = widget.recipeID?.difficulty;
          safeSetState(() {});
        }),
        Future(() async {
          _model.initialIgredients = await IngredientsTable().queryRows(
          ...
          _model.ingredients =
              _model.initialIgredients!.toList().cast<IngredientsRow>();
          safeSetState(() {});
        }),
        Future(() async {
          _model.initialStep = await StepTable().queryRows(
            queryFn: (q) => q.eqOrNull(
              'receipe_id',
              widget.recipeID?.id,
            ),
          );
          _model.steps = _model.initialStep!.toList().cast<StepRow>();
          safeSetState(() {});
        }),
        Future(() async {
          _model.initialTag = await ReceipeTagsTable().queryRows(
            queryFn: (q) => q.eqOrNull(
              'receipe_id',
              widget.recipeID?.id,
            ),
          );
          _model.tags = _model.initialTag!
                                                ...
                                                onTap: () async {
                                                  ...
                                                  if (selectedMedia != null &&
                                                      selectedMedia.every((m) =>
                                                          validateFileFormat(
                                                              ...
                                                              context))) {
                                                    safeSetState(() => _model
                                                            .isDataUploading_uploadLocalMainImageDraft =
                                                        true);
                                                    ...
                                                    try {
                                                      ...
                                                      _model.isDataUploading_uploadLocalMainImageDraft =
                                                          false;
                                                    }
                                                    if (selectedUploadedFiles
                                                        ...
                                                        downloadUrls.length ==
                                                            selectedMedia
                                                                .length) {
                                                      safeSetState(() {
                                                        _model.uploadedLocalFile_uploadLocalMainImageDraft =
                                                            selectedUploadedFiles
                                                                .first;
                                                        _model.uploadedFileUrl_uploadLocalMainImageDraft =
                                                            downloadUrls.first;
                                                      });
                                                    } else {
                                                      safeSetState(() {});
                                                  ...
                                                  _model.insertMainImage =
                                                      await ReceipeImageTable()
                                                          .insert({
                                                    'url': _model
                                                        .uploadedFileUrl_uploadLocalMainImageDraft,
                                                    'type': '',
                                                    'receipe_id':
                                                        widget.recipeID?.id,
                                                  });
                                                ...
                                                onTap: () async {
                                                  ...
                                                  if (selectedMedia != null &&
                                                      selectedMedia.every((m) =>
                                                          validateFileFormat(
                                                              ...
                                                              context))) {
                                                    safeSetState(() => _model
                                                            .isDataUploading_uploadLocalImagesDraft =
                                                        true);
                                                    var selectedUploadedFiles =
                                                        <FFUploadedFile>[];
                                                    ...
                                                    try {
                                                      ...
                                                      _model.isDataUploading_uploadLocalImagesDraft =
                                                          false;
                                                    }
                                                    if (selectedUploadedFiles
                                                                .length ==
                                                        ...
                                                        downloadUrls.length ==
                                                            selectedMedia
                                                                .length) {
                                                      safeSetState(() {
                                                        _model.uploadedLocalFile_uploadLocalImagesDraft =
                                                            selectedUploadedFiles
                                                                .first;
                                                        _model.uploadedFileUrl_uploadLocalImagesDraft =
                                                            downloadUrls.first;
                                                      });
                                                    } else {
                                                      safeSetState(() {});
                                                  ...
                                                  _model.insertImage =
                                                      await ReceipeImageTable()
                                                          .insert({
                                                    'url': _model
                                                        .uploadedFileUrl_uploadLocalImagesDraft,
                                                    'type': '',
                                                    'receipe_id':
                                                        widget.recipeID?.id,
                                                  });
                                                            ...
                                                            children: [
                                                              ...
                                                              Expanded(
                                                                child:
                                                                    UpdateIngredientWidget(
                                                                  key: Key(
                                                                      'Keyep1_${ingredientIndex}_of_${ingredient.length}'),
                                                                ),
                                                              ),
                                                              Column(
                                                                mainAxisSize:
