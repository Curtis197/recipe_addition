...
class RecipeWeeklyRevenueChartTable
    extends SupabaseTable<RecipeWeeklyRevenueChartRow> {
  @override
  String get tableName => 'recipe_weekly_revenue_chart';

  @override
  RecipeWeeklyRevenueChartRow createRow(Map<String, dynamic> data) =>
      RecipeWeeklyRevenueChartRow(data);
}

class RecipeWeeklyRevenueChartRow extends SupabaseDataRow {
  RecipeWeeklyRevenueChartRow(Map<String, dynamic> data) : super(data);

  @override
  SupabaseTable get table => RecipeWeeklyRevenueChartTable();
