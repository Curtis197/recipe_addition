...
Future<int> queryReceipeImageRecordCount({
  ...
  int limit = -1,
    ...
    queryCollectionCount(
      ReceipeImageRecord.collection,
      queryBuilder: queryBuilder,
      limit: limit,
    );

Stream<List<ReceipeImageRecord>> queryReceipeImageRecord({
  Query Function(Query)? queryBuilder,
  int limit = -1,
  bool singleRecord = false,
    ...
    queryCollection(
      ReceipeImageRecord.collection,
      ReceipeImageRecord.fromSnapshot,
      queryBuilder: queryBuilder,
      limit: limit,
      singleRecord: singleRecord,
    );

Future<List<ReceipeImageRecord>> queryReceipeImageRecordOnce({
  Query Function(Query)? queryBuilder,
  int limit = -1,
  bool singleRecord = false,
}) =>
