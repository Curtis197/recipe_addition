...
import 'edit_temporary_receipe_model.dart';
export 'edit_temporary_receipe_model.dart';

class EditTemporaryReceipeWidget extends StatefulWidget {
  const EditTemporaryReceipeWidget({
    super.key,
  ...
  static String routeName = 'EditTemporaryReceipe';
  static String routePath = '/editTemporaryReceipe';

  @override
  State<EditTemporaryReceipeWidget> createState() =>
      _EditTemporaryReceipeWidgetState();
}

class _EditTemporaryReceipeWidgetState
    extends State<EditTemporaryReceipeWidget> {
  late EditTemporaryReceipeModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => EditTemporaryReceipeModel());
    ...
    _model.insertReceipetimeofcookingMinTextController ??=
        TextEditingController();
    _model.insertReceipetimeofcookingMinFocusNode ??= FocusNode();
                                      ...
                                      children: [
                                          ...
                                          FutureBuilder<List<ReceipeImageRow>>(
                                            ...
                                            builder: (context, snapshot) {
                                              ...
                                              return Wrap(
                                                ...
                                                children: [
                                                  if ((_model
                                                              .uploadedLocalFile_updateNewImage
                                                              .bytes
                                                              ?.isNotEmpty ??
                                                          false))
                                                    ClipRRect(
                                                      borderRadius:
                                                          BorderRadius.circular(
                                                              8.0),
                                                      child: Image.memory(
                                                        _model.uploadedLocalFile_updateNewImage
                                                                .bytes ??
                                                            Uint8List.fromList(
                                                                []),
                                                        width: 100.0,
                                                  ...
                                                  if ((_model.uploadedLocalFile_updateNewImage
                                                              .bytes?.isEmpty ??
                                                          true))
                                                    InkWell(
                                                      splashColor:
                                                        ...
                                                        if (selectedMedia !=
                                                            ...
                                                            selectedMedia.every((m) =>
                                                                validateFileFormat(
                                                                    ...
                                                                    context))) {
                                                          safeSetState(() =>
                                                              _model.isDataUploading_updateNewImage =
                                                                  true);
                                                  ...
                                                  InkWell(
                                                    ...
                                                    onTap: () async {
                                                      if ((_model
                                                        ...
                                                        {
                                                          safeSetState(() =>
                                                              _model.isDataUploading_uploadedEditNewReceipeimage =
                                                                  true);
                                                          var selectedUploadedFiles =
                                                              <FFUploadedFile>[];
                                                          var selectedMedia =
                                                          ...
                                                          if (selectedUploadedFiles
                                                              ...
                                                              downloadUrls
                                                                  ...
                                                                  selectedMedia
                                                                      .length) {
                                                            safeSetState(() {
                                                              _model.uploadedLocalFile_uploadedEditNewReceipeimage =
                                                                  selectedUploadedFiles
                                                                      .first;
                                                              _model.uploadedFileUrl_uploadedEditNewReceipeimage =
                                                                  downloadUrls
                                                                      .first;
                                                            });
                                                          } else {
                                                        ...
                                                        await ReceipeImageTable()
                                                          ...
                                                          data: {
                                                            'url': _model
                                                                .uploadedFileUrl_uploadedEditNewReceipeimage,
                                                            'type': _model
                                                                        .dropDownValue1 ==
                                                                    'principal'
                                                                ? 'main'
                                        ...
                                        if (!_model.editImage)
                                          Wrap(
                                            ...
                                            clipBehavior: Clip.none,
                                            children: [
                                              if ((_model.uploadedLocalFile_edtNewImage
                                                          .bytes?.isNotEmpty ??
                                                      false))
                                                ClipRRect(
                                                  borderRadius:
                                                      BorderRadius.circular(
                                                          8.0),
                                                  child: Image.memory(
                                                    _model.uploadedLocalFile_edtNewImage
                                                            .bytes ??
                                                        Uint8List.fromList([]),
                                                    width: 100.0,
                                                    height: 100.0,
                                                  ...
                                                  onTap: () async {
                                                    ...
                                                    if (selectedMedia != null &&
                                                      ...
                                                      try {
                                                        ...
                                                        _model.isDataUploading_edtNewImage =
                                                            false;
                                                      }
                                                      if (selectedUploadedFiles
                                                              .length ==
                                              ...
                                              InkWell(
                                                ...
                                                onTap: () async {
                                                  {
                                                    safeSetState(() => _model
                                                            .isDataUploading_uploadedNewReceipeimage =
                                                        true);
                                                    var selectedUploadedFiles =
                                                        <FFUploadedFile>[];
                                                    var selectedMedia =
                                                    ...
                                                    try {
                                                      ...
                                                      _model.isDataUploading_uploadedNewReceipeimage =
                                                          false;
                                                    }
                                                    if (selectedUploadedFiles
                                                                .length ==
                                                        ...
                                                        downloadUrls.length ==
                                                            selectedMedia
                                                                .length) {
                                                      safeSetState(() {
                                                        _model.uploadedLocalFile_uploadedNewReceipeimage =
                                                            selectedUploadedFiles
                                                                .first;
                                                        _model.uploadedFileUrl_uploadedNewReceipeimage =
                                                            downloadUrls.first;
                                                      });
                                                    } else {
                                                      safeSetState(() {});
                                                  ...
                                                  _model.insertTemporaryImage =
                                                    ...
                                                    'temporary_receipe_id':
                                                        columnTemporaryReceipeRow
                                                            ?.id,
                                                    'url': _model
                                                        .uploadedFileUrl_uploadedNewReceipeimage,
                                                    'type':
                                              ...
                                              return Row(
                                                ...
                                                children: [
                                                  ...
                                                  Container(
                                                    ...
                                                    child: TextFormField(
                                                      controller: _model
                                                          .insertReceipetimeofcookingMinTextController,
                                                      focusNode: _model
                                                          .insertReceipetimeofcookingMinFocusNode,
                                                      autofocus: false,
                                                      obscureText: false,
                                                      decoration:
                                                          InputDecoration(
                                                                    ...
                                                                    if (_model
                                                                      ...
                                                                      wrapWithModel(
                                                                        ...
                                                                        child:
                                                                          ...
                                                                          key:
                                                                              Key(
                                                                            'Key8zf_${ingredientRowItem.id}',
                                                                          ),
                                                                          ingredients:
                                                                              ingredientRowItem,
                                                                        ),
                                                                      ),
                                                                    if ((_model.ingredientID !=
                                                                            ingredientRowItem
                                                                                .id) &&
                                                                        ingredientRowItem
                                                                            .title!)
                                                                      Row(
                                                                        mainAxisSize:
                                                                            MainAxisSize.max,
                                                                        children: [
                                                                          if (ingredientRowItem.name != null &&
                                                                    ...
                                                                    if ((_model.ingredientID !=
                                                                      ...
                                                                      Row(
                                                                        ...
                                                                        children:
                                                                          ...
                                                                          if ((ingredientRowItem.unit != null && ingredientRowItem.unit != '') &&
                                                                              (ingredientRowItem.unit != 'sans unité'))
                                                                            Container(
                                                                              decoration: BoxDecoration(
                                                                                color: FlutterFlowTheme.of(context).secondaryBackground,
                                                                              ),
                                                                  ...
                                                                  onTap:
                                                                    ...
                                                                    _model.updatedIngredient =
                                                                      ...
                                                                      data: {
                                                                        ...
                                                                        'quantity': double.tryParse(_model.editingredientModels.getValueForKey(
                                                                    ...
                                                                    return FlutterFlowDropDown<
                                                                      ...
                                                                      controller: _model
                                                                          ...
                                                                          FormFieldController<
                                                                              String>(
                                                                        _model
                                                                            .foodRegionEditValue ??= columnTemporaryReceipeRow?.foodRegion != null &&
                                                                      ...
                                                                      onChanged:
                                                                          (val) =>
                                                                              safeSetState(() => _model.foodRegionEditValue = val),
                                                                      width:
                                                                          200.0,
                                                                      height:
                                                                          40.0,
                                                                    ...
                                                                    return FlutterFlowDropDown<
                                                                      ...
                                                                      controller: _model
                                                                          ...
                                                                          FormFieldController<
                                                                              String>(
                                                                        _model
                                                                            .foodRegionCreateValue ??= columnTemporaryReceipeRow?.foodRegion != null &&
                                                                                columnTemporaryReceipeRow?.foodRegion != ''
                                                                            ? columnTemporaryReceipeRow?.foodRegion
                                                                            : '',
                                                                      ),
                                                                      ...
                                                                      onChanged:
                                                                          (val) =>
                                                                              safeSetState(() => _model.foodRegionCreateValue = val),
                                                                      width:
                                                                          200.0,
                                                                      height:
                                                                          40.0,
                                                            ...
                                                            child: Column(
                                                              mainAxisSize:
                                                                  MainAxisSize
                                                                      .max,
                                                              children: [
                                                                if ((columnTemporaryReceipeRow?.difficulty !=
                                                                            null &&
                                                                    ...
                                                                    children: [
                                                                      FutureBuilder<
                                                                        ...
                                                                        builder:
                                                                          ...
                                                                          return FlutterFlowDropDown<
                                                                              String>(
                                                                            controller: _model.difficulyEditValueController ??=
                                                                                FormFieldController<String>(
                                                                              _model.difficulyEditValue ??= columnTemporaryReceipeRow?.difficulty != null && columnTemporaryReceipeRow?.difficulty != '' ? columnTemporaryReceipeRow?.difficulty : '',
                                                                            ),
                                                                      ...
                                                                      InkWell(
                                                                        ...
                                                                        onTap:
                                                                          ...
                                                                          await TemporaryReceipeTable()
                                                                              .update(
                                                                            data: {
                                                                              'difficulty': _model.difficulyEditValue,
                                                                            },
                                                                            matchingRows: (rows) =>
                                                                                rows.eqOrNull(
                                                                              'id',
                                                                    ...
                                                                    children: [
                                                                      FutureBuilder<
                                                                        ...
                                                                        builder:
                                                                          ...
                                                                          return FlutterFlowDropDown<
                                                                              String>(
                                                                            controller: _model.difficultyCreateValueController ??=
                                                                                FormFieldController<String>(
                                                                              _model.difficultyCreateValue ??= columnTemporaryReceipeRow?.difficulty != null && columnTemporaryReceipeRow?.difficulty != '' ? columnTemporaryReceipeRow?.difficulty : '',
                                                                            ),
                                                                            options:
                                                                                difficultyCreateDifficultyRowList.map((e) => e.name).withoutNulls.toList(),
                                                                            onChanged: (val) =>
                                                                      ...
                                                                      InkWell(
                                                                        ...
                                                                        onTap:
                                                                          ...
                                                                          await TemporaryReceipeTable()
                                                                              .update(
                                                                            data: {
                                                                              'difficulty': _model.difficultyCreateValue,
                                                                            },
                                                                            matchingRows: (rows) =>
                                                                                rows.eqOrNull(
                                                                              'id',
