...
import 'insert_step_model.dart';
export 'insert_step_model.dart';

class InsertStepWidget extends StatefulWidget {
  const InsertStepWidget({
    super.key,
    this.step,
  });
  ...
  @override
  State<InsertStepWidget> createState() => _InsertStepWidgetState();
}

class _InsertStepWidgetState extends State<InsertStepWidget> {
  late InsertStepModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => InsertStepModel());

    _model.numberPCTextController ??= TextEditingController();
