...
import 'update_ingredient_model.dart';
export 'update_ingredient_model.dart';

class UpdateIngredientWidget extends StatefulWidget {
  ...
  @override
  State<UpdateIngredientWidget> createState() => _UpdateIngredientWidgetState();
}

class _UpdateIngredientWidgetState extends State<UpdateIngredientWidget> {
  late UpdateIngredientModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => UpdateIngredientModel());

    _model.quantityPCTextController ??=
        TextEditingController(text: widget.ingredients?.quantity?.toString());
    _model.quantityPCFocusNode ??= FocusNode();

    _model.textPCTextController ??=
        TextEditingController(text: widget.ingredients?.name);
    _model.textPCFocusNode ??= FocusNode();

    _model.quantityPhoneTextController ??=
        TextEditingController(text: widget.ingredients?.quantity?.toString());
                ...
                builder: (context, snapshot) {
                  ...
                  return FlutterFlowDropDown<String>(
                    controller: _model.unitPCValueController ??=
                      ...
                      _model.unitPCValue ??= widget.ingredients?.unit,
                    ),
                    ...
                    builder: (context, snapshot) {
                      ...
                      return FlutterFlowDropDown<String>(
                        controller: _model.unitPhoneValueController ??=
                            FormFieldController<String>(
                          _model.unitPhoneValue ??= widget.ingredients?.unit,
                        ),
